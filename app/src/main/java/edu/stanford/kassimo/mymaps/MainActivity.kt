    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mapAdapter = MapsAdapter(this, userMaps, object: MapsAdapter.OnClickListener {
            override fun onItemClick(position: Int) {
                ...
                val intent = Intent(this@MainActivity, DisplayMapActivity::class.java) // this@MainActivity is used to reference "this" of a certain wrapping context (otherwise there will be confusion)
